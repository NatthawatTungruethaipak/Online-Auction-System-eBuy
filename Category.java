...
public class Category
{
	...
	{
		String[] strArray = {"Electronics", "Collecibles & Art", "Fashion",
							"Home & Garden", "Sporting Goods", "Health & Beauty",
							"Toys & Hobbies", "Books", "Movies", "Music",
							"Business & Industrial", "Vehicle", "Other"};
	 ...
	 * @return Category instance that finding from string. If not found, Category of "Other".
	 */
	 ...
	 * @return True if string inside category and string that want
	 * 			to compare is the same. Otherwise, False.
	 */
